...
async def user_help(message: Message):
    answer_message1 = 'Для начла расчета нажмите кнопку ' + btn_calc_t.text + ' и следуйте инструкциям.\n Названия ' \
                                                                              'точек и их координаты можно вводить в ' \
                                                                              'одном сообщении или в нескольких (' \
                                                                              'попорядку). '
    answer_message2 = 'В меню ' + btn_show_climate_zone.text + ' можно узнать значение климатической поправки для ' \
                                                               'региона. '
